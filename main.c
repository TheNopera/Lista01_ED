...
void lerArquivo(ListaArtistas *lista) {
    ...
    while (fgets(linha, sizeof(linha), arquivo)) {
        ...
        // Alocar memória para um novo artista na lista
        ...
        // Leitura de nome, gênero e local
...
void criarMenu() {
    ...
    printf("4. Buscar album por nome\n");
	printf("5. Editar\n");
    printf("6. Sair\n");
...
void editarArtista(ListaArtistas *lista, const char *nome) {
    ...
    for (int i = 0; i < artista->num_albuns; i++) {
        printf("Novo nome do album %d: ", i + 1);
